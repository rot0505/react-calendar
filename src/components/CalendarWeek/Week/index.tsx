    ...
    <div className={styles.calendar_week}>
      {weekDays.map((day) => {
        ...
        const dayEvents = events?.filter((event) => {
          ...
          return eventStartDate.getTime() > day.date.getTime() && eventEndDate.getTime() < nextDay.getTime();
        });
        ...
        const prevDayEvents = events.filter((event) => {
          ...
          return day.date.getTime() <= eventEndDate.getTime() && day.date.getTime() > eventStartDate.getTime();
        });
        ...
        const nextDayEvents = events.filter((event) => {
          ...
          return nextDay.getTime() > eventStartDate.getTime() && nextDay.getTime() <= eventEndDate.getTime();
        });
